...
describe("Cline Customize View Layout & Feature Parity", () => {
  test("renders all 6 CUSTOMIZE_TABS: Tools 10, Plugins 0, Skills 17, Rules 0, MCP 0, Hooks 0", () => {
    const html = renderToStaticMarkup(<CustomizeView />);
    expect(html).toContain("Customize");
    expect(html).toContain("Extend what Fusion can do and how it works");
  ...
  test("renders no marketplace button in Fusion-branded customize page", () => {
    const html = renderToStaticMarkup(<CustomizeView />);
    expect(html).not.toContain('data-testid="customize-marketplace-btn"');
